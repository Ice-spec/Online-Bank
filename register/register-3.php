...
if(!isset($_SESSION['save_first'])) { // if the form not yet submitted
          ...
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <div class="ugf-form-block-header">
                ...
                <p>Let's get to know you more <br> Enter contact information</p>
              </div>
              
              <div class="ugf-input-block">
                <form action="register3_engine.php" method="POST">
                  <div class="form-group">
                    <input type="text" class="form-control" id="inputText" name="str" placeholder="Street" required="">
                    <label for="input-text"><i class=""></i></label>
                  </div>
                  <div class="form-group pass-block">
                    <input type="text" class="form-control" name="city" id="inputPass" placeholder="City" required="">
                    <label for="input-pass"><i class="las la-unlock"></i></label><br>

                    <input type="text" class="form-control" id="inputText" name="state" placeholder="State" required="">
                    <label for="input-text"><i class=""></i></label><br>
